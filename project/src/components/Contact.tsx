              ...
              <div className="mt-8 pt-8 border-t border-slate-700">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="flex-1 flex items-center justify-center gap-2 p-3 bg-slate-700/30 rounded-lg hover:bg-cyan-500/20 transition-all group"
                  >
          ...
          <div className="bg-slate-800/50 backdrop-blur-lg rounded-2xl p-8 border border-slate-700">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-4 py-3 bg-slate-700/50 border border-slate-600 rounded-lg focus:border-cyan-500 focus:outline-none text-slate-200 transition-all"
              ...
              <div>
                ...
                <textarea
                  rows={5}
                  className="w-full px-4 py-3 bg-slate-700/50 border border-slate-600 rounded-lg focus:border-cyan-500 focus:outline-none text-slate-200 transition-all resize-none"
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300 flex items-center justify-center gap-2 group"
              >
