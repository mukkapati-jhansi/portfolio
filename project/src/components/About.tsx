      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-8">
            ...
            {/* EDUCATION */}
            <div className="bg-slate-800/50 backdrop-blur-lg rounded-2xl p-8 border border-slate-700 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/10">
            ...
            {/* CAREER OBJECTIVE */}
            <div className="bg-slate-800/40 rounded-xl p-8 border border-slate-700">
